<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductoModi.aspx.cs" Inherits="MaestroDetalleEntidad.ProductoModi" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3">
                    ...
                    <asp:Button ID="Button3" runat="server" BackColor="#0000CC" ForeColor="White" OnClick="Button3_Click" Text="Buscar" />
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
